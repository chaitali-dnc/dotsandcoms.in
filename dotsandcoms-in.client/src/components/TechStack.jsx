  ...
  const techs = [
    {
      ...
      icon: <img src="/react-js.png" className="h-10 w-auto object-contain" alt="React JS" />,
    },
    {
      name: "ASPX Core",
      ...
      icon: <img src="/asp-net-icon.png" className="h-10 w-auto object-contain" alt="ASPX Core" />,
    },
    {
      name: "Node JS",
      role: "Backend APIs",
      ...
      icon: <img src="/node-logo-dark.svg" className="h-8 w-auto object-contain" alt="Node JS" />,
    },
    {
      name: "Flutter",
      ...
      icon: <img src="/flutter-icon.png" className="h-10 w-auto object-contain" alt="Flutter" />,
    },
    {
      name: "Figma",
      ...
      icon: <img src="/figma-ui-ux-developer.png" className="h-10 w-auto object-contain" alt="Figma" />,
    },
    {
      name: "Shopify",
      role: "E-Commerce",
      ...
      icon: <img src="/shopify_logo_black.png" className="h-7 w-auto object-contain" alt="Shopify" />,
    },
    {
      name: "Hosting",
      ...
      icon: <img src="/cloud-computing.png" className="h-10 w-auto object-contain" alt="Hosting" />,
    },
    {
      ...
      icon: <img src="/seo.png" className="h-9 w-auto object-contain" alt="SEO & Digital Marketing" />,
    },
  ];
