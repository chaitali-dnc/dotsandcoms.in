  ...
  const techs = [
    {
      ...
      icon: <img src="/react-js.png" className="h-10 w-auto object-contain" alt="React JS - Modern frontend development library for interactive web applications" />,
    },
    {
      name: "ASPX Core",
      ...
      icon: <img src="/asp-net-icon.png" className="h-10 w-auto object-contain" alt="ASP.NET Core - High performance backend framework for secure web APIs" />,
    },
    {
      name: "Node JS",
      role: "Backend APIs",
      ...
      icon: <img src="/node-logo-dark.svg" className="h-8 w-auto object-contain" alt="Node JS - Scalable JavaScript runtime for custom API development" />,
    },
    {
      name: "Flutter",
      ...
      icon: <img src="/flutter-icon.png" className="h-10 w-auto object-contain" alt="Flutter - Cross platform framework for Android and iOS mobile app development" />,
    },
    {
      name: "Figma",
      ...
      icon: <img src="/figma-ui-ux-developer.png" className="h-10 w-auto object-contain" alt="Figma - Collaborative design tool for custom UI UX prototypes" />,
    },
    {
      name: "Shopify",
      role: "E-Commerce",
      ...
      icon: <img src="/shopify_logo_black.png" className="h-7 w-auto object-contain" alt="Shopify - Headless e-commerce development platform for online stores" />,
    },
    {
      name: "Hosting",
      ...
      icon: <img src="/cloud-computing.png" className="h-10 w-auto object-contain" alt="Web Hosting - Secure server hosting and deployment solutions" />,
    },
    {
      ...
      icon: <img src="/seo.png" className="h-9 w-auto object-contain" alt="SEO & Digital Marketing - Search engine optimization for business growth" />,
    },
  ];
